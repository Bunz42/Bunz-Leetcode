...
**When do you use opposite ends?** This approach is probably the most common, and a giveaway you should look for is when the problem asks
...
**When do you use Same Direction?** This one's pretty common for linked list problems, or for some in-place array modification problems
